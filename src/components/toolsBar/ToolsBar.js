        ...
        return(
            <Collapse defaultActiveKey={['1']} >
                    <Panel header="基础组件" key="1">
                        ...
                        <Button type="dashed" style={{'marginRight':'7px'}} onClick={this.addCol.bind(this,'word')}>文字</Button>
                    </Panel>
                    <Panel header="表单" key="2">
                    <Button type="dashed" style={{'marginRight':'7px'}} onClick={this.addCol.bind(this,'form')}>表单</Button>
                    <Button type="dashed" style={{'marginRight':'7px'}} onClick={this.addCol.bind(this,'button')}>文本框</Button>
                    </Panel>
